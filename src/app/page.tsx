    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid gap-2 text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-3 lg:text-left">
        <a
          ...
          className="group border-2 p-3 transition-colors bg-neutral-800/30 border-neutral-800 hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/40"
          target="_blank"
